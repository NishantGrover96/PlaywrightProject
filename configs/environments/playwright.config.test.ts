...
function getAuthStoragePath(clientId?: string, role?: string, env?: string): string {
  ...
  const environment = env || process.env.ENV || 'test';
 ...
 * Uses TEST environment URLs and credentials
 *
 * ✅ Test environment - balanced approach between dev and production
 */
...
export default defineConfig({
  ...
  use: {
    ...
    baseURL: process.env.BASE_URL || 'https://demoportaltest.channel-fusion.com',
